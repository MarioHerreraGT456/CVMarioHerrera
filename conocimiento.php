...
<div id="main-content" class="">
        ...
        <div >
            <img id="conocimiento" src="images/image5.png" alt="Mario Herrera">
          <div id="skils-container" class="skils-container">
        <div class="skil-item red-item">
                <img src="/images/Html 5.png" alt="">
                <div class="skil-tooltip-box">
                    <p class="tooltip-title">CONOCIMIENTOS SÓLIDOS EN HTML 5</p>
                </div>
            </div>
            <div class="skil-item red-item">
                <img src="/images/CSS3.png" alt="">
                <div class="skil-tooltip-box">
                    <p class="tooltip-title">CONOCIMIENTOS SÓLIDOS EN CSS 3</p>
            ...
            <div class="skil-item red-item">
                <img src="/images/JavaScript.png" alt="">
                 <div class="skil-tooltip-box">
                    <p class="tooltip-title">CONOCIMIENTOS AVANZADOS EN JS</p>
            ...
            <div class="skil-item red-item">
                <img src="/images/Tailwind CSS.png" alt="">
                 <div class="skil-tooltip-box">
                    <p class="tooltip-title">CONOCIMIENTOS SÓLIDOS EN TAILWIND</p>
            ...
            <div class="skil-item red-item">
                <img src="/images/Bootstrap.png" alt="">
                 <div class="skil-tooltip-box">
                    <p class="tooltip-title">CONOCIMIENTOS SÓLIDOS EN BOOTSTRAP
                    </p>
            ...
            <div class="skil-item red-item">
                <img src="/images/Laravel.png" alt="">
                 <div class="skil-tooltip-box">
                    <p class="tooltip-title">CONOCIMIENTOS SÓLIDOS EN LARAVEL</p>
                </div>
            </div>
...
<div id="main-content-light" class="hidden">
        <section class="page-light">
         ...
         <div >
            <img id="conocimiento" src="images/image5.png" alt="Mario Herrera">
          <div id="skils-container-light" class="skils-container">
        <div class="skil-item blue-item">
                <img src="/images/Html 5.png" alt="">
                <div class="skil-tooltip-box-blue">
                    <p class="tooltip-title">CONOCIMIENTOS SÓLIDOS EN HTML 5</p>
                </div>
            </div>
            <div class="skil-item blue-item">
