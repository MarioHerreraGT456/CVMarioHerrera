...
<div id="main-content" class="">
        ...
        <div class="exp-container">
            <img id="exp" src="images/image4.png" alt="Mario Herrera">
            <div class="exp-info-container koulen-regular">
                <div class="exp-info-item">
                    <div class="exp-info-img1"></div>
                    <div class="exp-info">
                        <h3 class="">
                             Colegio de Contadores Públicos del Estado Miranda (Mi Boutique)
                        </h3>
                        <p>
                            - Diseño y Desarrollo del e-commerce del Colegio de Contadores. <br>
- Optimización del rendimiento y aplicación de técnicas de SEO. <br>
- Diseño de interfaces responsivas. <br>
- Tecnologías: WordPress, Elementor, WooCommerce, Canva<br>
                        </p>
                    </div>
                </div>
                <div class="exp-info-item">
                    <div class="exp-info-img2"></div>
                    <div class="exp-info">
                        <h3 class="">
                             Clinmedia Agencia de Marketing 
                        </h3>
                        <p>
                            Desarrollo y gestión de páginas web y tiendas virtuales en WordPress con Elementor y WooCommerce. <br>- Desarrollo y gestión de páginas web y tiendas virtuales en WordPress con Elementor y WooCommerce. <br>
- Optimización del rendimiento y aplicación de técnicas de SEO. <br>
- Diseño de interfaces responsivas para móviles, tablets y PCs. <br>
- Tecnologías: WordPress, Elementor, WooCommerce, JavaScript, Figma, Canva
                        </p>
                    </div>
                </div>
                <div class="exp-info-item">
                    <div class="exp-info-img3"></div>
                    <div class="exp-info">
                        <h3 class="">
                             Tnvio
                        </h3>
                        <p>
                            https://tnvio.com 
Plataforma para enviar dinero de México a Venezuela con protocolos transparentes y confiables, construcción de la base de datos para el buen manejo de la información de los usuarios para la conversión del peso mexicano a bolívares de la manera mas rápida y eficiente.<br> 
- Tecnologías: Laravel, PostgreSQL, Alpine.js, Tailwind CSS, Figma y Git.<br> 
- Diseño de interfaces responsivas para móviles, tablets y PCs<br> 
                        </p>
                    </div>
                </div>
                <div class="exp-info-item">
                    <div class="exp-info-img4"></div>
                    <div class="exp-info">
                        <h3 class="">
                             Universidad Bicentenarita de Aragua (CAP)
                        </h3>
                        <p>
                           Optimización y actualización de la pagina web del Centro de Atención Psicológica de la Universidad Bicentenaria de Aragua. Desarrollado con WordPress.<br> 
                        </p>
                    </div>
                </div>
            </div>
